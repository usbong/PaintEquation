 ...
 * @date updated: 20220428; from 20210514
...
//    load_tga("textures/armor.tga");	
	...
	if (myKahonTextureObject==KAHON_TEXTURE) {
    	load_tga((char*)"textures/imageSpriteExampleMikeWithoutBG.tga");	
	}
	else if (myKahonTextureObject==ARMOR_TEXTURE) {
    	load_tga((char*)"textures/armor.tga");	
	}
	else {  //BAHAY_TEXTURE
    	load_tga((char*)"textures/bahay.tga");	
	}	
...
/*
	float fColumnSquareWidth = myWindowWidt	
